...
export function seedDatabase() {
  ...
  for (const u of users) {
    db.upsertUser(u);
    const topupAmount = u.id === 'usr_marc' ? 4500 : u.id === 'usr_alex' ? 7500 : 5000;
    db.topupWallet(u.id, topupAmount, `pi_seed_${u.id}`);
  }

  // 2. Seed Posts, Demands & Counter-Opinions
  const rawPosts = [
    {
      id: 'post_mcd_demand',
      ...
      body: 'Over 14,000 fans have backed this demand with real money. The market has spoken — make Szechuan sauce a permanent menu fixture across all stores.',
      counter_of: null,
      author_display: 'Alex Vance',
      status: 'live' as const,
      total_raised_cents: 512000,
      backers_count: 14800,
      like_units: 42000,
      streak_days: 6,
      created_at: new Date(now - 6 * 86400000).toISOString(),
      target_dollars_now: 3890.0,
    },
    {
      id: 'post_messi',
      ...
      author_display: 'Alex Vance',
      status: 'live' as const,
      total_raised_cents: 425000,
      backers_count: 14200,
      like_units: 32400,
      streak_days: 5,
      created_at: new Date(now - 5 * 86400000).toISOString(),
      target_dollars_now: 3450.0,
    },
    {
      id: 'post_ronaldo',
      ...
      status: 'live' as const,
      total_raised_cents: 395000,
      backers_count: 12850,
      like_units: 28900,
      streak_days: 1,
      created_at: new Date(now - 4 * 86400000).toISOString(),
      target_dollars_now: 3180.0,
    },
    {
      ...
      status: 'live' as const,
      total_raised_cents: 310000,
      backers_count: 9400,
      like_units: 18200,
      streak_days: 2,
      created_at: new Date(now - 3 * 86400000).toISOString(),
      target_dollars_now: 2650.0,
    },
    {
      id: 'post_shipfast',
      ...
      author_display: 'Marc (ShipFast)',
      status: 'live' as const,
      total_raised_cents: 280000,
      backers_count: 4120,
      like_units: 14800,
      streak_days: 0,
      created_at: new Date(now - 3 * 86400000).toISOString(),
      target_dollars_now: 2420.0,
    },
    {
      id: 'post_vc_ai',
    ...
    },
    {
      ...
      author_display: 'Marc (ShipFast)',
      status: 'live' as const,
      total_raised_cents: 645000,
      backers_count: 18900,
      like_units: 52000,
      streak_days: 7,
      created_at: new Date(now - 7 * 86400000).toISOString(),
      target_dollars_now: 5200.0,
    },
    {
      id: 'post_chatgpt',
      ...
      author_display: 'Dr. Elena Rostova',
      status: 'live' as const,
      total_raised_cents: 582000,
      backers_count: 16400,
      like_units: 46000,
      streak_days: 3,
      created_at: new Date(now - 6 * 86400000).toISOString(),
      target_dollars_now: 4750.0,
    },
    {
      id: 'post_gemini',
      ...
      author_display: 'Alex Vance',
      status: 'live' as const,
      total_raised_cents: 498000,
      backers_count: 14100,
      like_units: 39000,
      streak_days: 2,
      created_at: new Date(now - 5 * 86400000).toISOString(),
      target_dollars_now: 4100.0,
    },
    {
      id: 'post_grok',
      ...
      status: 'live' as const,
      total_raised_cents: 435000,
      backers_count: 12600,
      like_units: 34000,
      streak_days: 1,
      created_at: new Date(now - 4 * 86400000).toISOString(),
      target_dollars_now: 3600.0,
    },
  ];
